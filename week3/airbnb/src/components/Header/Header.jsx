  ...
  return (
    <div className="header">
        ...
        <div className="header__choice">
          <button type="button" className="button-where">어디든지</button>
          <button type="button" className="button-where">언제든 일주일</button>
          <button type="button" className="button-where">게스트 추가</button>
